...
# -------------------------------------------------------
# ALB security group — public-facing, HTTP on port 80
# -------------------------------------------------------
...
# -------------------------------------------------------
# Ghost ECS security group — allows ALB on port 2368
# -------------------------------------------------------
resource "aws_security_group" "ghost" {
  name        = "${local.name_prefix}-ghost-sg"
  description = "Ghost ECS tasks - ALB traffic only"
  vpc_id      = module.vpc.vpc_id
...
# -------------------------------------------------------
# Webhook ECS security group — egress only, no inbound
# -------------------------------------------------------
resource "aws_security_group" "webhook" {
  name        = "${local.name_prefix}-webhook-sg"
  description = "Webhook receiver ECS tasks - no inbound"
  vpc_id      = module.vpc.vpc_id
...
# -------------------------------------------------------
# Database security group — allows Ghost ECS on port 3306
# -------------------------------------------------------
